...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <title>{{ config('app.name', 'Waiting for name') }}</title>
    <!-- Simple bar CSS -->
  ...
  <body class="vertical  light rtl ">
    <div class="wrapper">
      <nav class="topnav navbar navbar-light" style="background-color: #6c7d4766; color:#fff;">
        <button type="button" class="navbar-toggler text-light mt-2 p-0 mr-3 collapseSidebar">
          <i class="fe fe-menu navbar-toggler-icon"></i>
        </button>
        <form class="form-inline mr-auto searchform text-light">
          <input class="form-control mr-sm-2 bg-transparent border-0 pl-4 text-light" type="search" placeholder="Type something..." aria-label="Search">
        </form>
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link text-l my-2" href="#" id="modeSwitcher" data-mode="light">
      ...
      <aside class="sidebar-left border-right bg-ourcolor shadow" id="leftSidebar" data-simplebar style="background-color:#fff">
        ...
        <nav class="vertnav navbar navbar-light" >
          ...
          <div class="w-100 mb-4 d-flex">
            <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="./index.html">
                <img src="{{asset('frontend/img/logo.png')}}" alt="Logo" class="navbar-brand-img mx-auto" width="80%">
            </a>
          </div>
          <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item @if(Route::currentRouteName() == 'landmarks.index' ) active @endif">
                <a class="nav-link pl-3" href="{{route('landmarks.index')}}"><span class="ml-1 item-text">{{__('list of added landmarks')}}</span></a>
            </li>
            <li class="nav-item  @if(Route::currentRouteName() == 'landmarks.create' ) active @endif">
