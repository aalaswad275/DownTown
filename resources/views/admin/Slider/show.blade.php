              ...
              <div class="row mt-5 align-items-center">
                <div class="col-md-3 text-center mb-5">
                  <div class="avatar avatar-xl">
                    <img src="{{asset('frontend/img/'.$slider->image)}}" alt="..." class="avatar-img round-square">
                  </div>
                </div>
                <div class="col">
                  <div class="row align-items-center">
                    <div class="col-md-7">
                      <h4 class="mb-1">{{$slider->title}}</h4>
                      <p class="small mb-3"><span class="badge badge-dark">{{$slider->subtitle}}</span></p>
                    </div>
                  </div>
                  <div class="row mb-4">
                    <div class="col-md-7">
