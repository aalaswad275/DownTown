                    ...
                    <div class="card-body">
                      <div class="row align-items-center">
                        ...
                        <div class="col pr-0">
                          ...
                          <p class="small text-light mb-0">{{__('Store')}}</p>
                          <span class="h3 mb-0 text-white">{{ $stores->count() }}</span>
                          </a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body">
                      <div class="row align-items-center">
                        ...
                        <div class="col pr-0">
                          ...
                          <p class="small text-muted mb-0">{{__('Landmarks')}}</p>
                          <span class="h3 mb-0">{{ $landmarks->count() }}</span>
                  ...
                  <div class="card shadow">
                    <div class="card-body">
                      <div class="row align-items-center">
                        ...
                        <div class="col">
                            <a href="{{ route('sliders.index') }}" target="_blank" rel="noopener noreferrer">
                          <p class="small text-muted mb-0">{{__('Sliders')}}</p>
                          <div class="row align-items-center no-gutters">
                            <div class="col-auto">
                              <span class="h3 mr-2 mb-0"> {{ $sliders->count() }}</span>
                            </div>
